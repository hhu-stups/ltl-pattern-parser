...
public class LtlBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LtlVisitor<T> {
	...
	@Override public T visitActionExpression(LtlParser.ActionExpressionContext ctx) { return visitChildren(ctx); }

	@Override public T visitUnary_op(LtlParser.Unary_opContext ctx) { return visitChildren(ctx); }

	@Override public T visitEnabledExpression(LtlParser.EnabledExpressionContext ctx) { return visitChildren(ctx); }
